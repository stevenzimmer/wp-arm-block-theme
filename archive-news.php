...
$posts_count = wp_count_posts("news", "publish");
...
<section class="bg-grey-100">
  <div class="container">
      <div class=""><h1>Articles & News about Armory</h1></div>
    ...
    <?php while ( have_posts() ) : the_post(); ?>
      ...
      <div class="main-content-container container">
          <div id="post-<?php the_ID(); ?>" <?php post_class("post-content-wrapper"); ?>>
              ...
              <a class="no-underline block hover:no-underline " href="<?php print get_permalink(); ?>">
                <h3 class="text-blue-lighter font-asBold hover:text-opacity-70 duration-200 transition-all no-underline"><?php the_title(); ?></h3>
              </a>
